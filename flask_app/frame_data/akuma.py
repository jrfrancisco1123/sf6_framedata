...
uniques = {
    ...
    'resso snap kick': ['10', '10-12', '15', ['5', '-4'], '700', 'High'],
...
specials = { 
    ...
    'od gou shoryuken': ['6', '6-16', '37+15 frames after landing', ['D', '-39'], '1700', 'High'],
...
super_arts = {
    ...
    'shun goku satsu': ['6+0', '6-27', '57', ['D', ''], '4700', 'Throw']
}
