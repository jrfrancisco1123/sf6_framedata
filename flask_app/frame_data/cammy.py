...
specials = {
    ...
    'cannon strike (during forward jump)': ['13', '13-23', '12 frames after landing', ['0~9', '-6~3'], '600', 'High'],
    'od cannon strike (during forward jump)': ['13', '13-22', '12 frames after landing', ['0~9', '-3~5'], '800', 'High'],
    ...
    'razors edge slicer (charged) (during hooligan combination) (no input)': ['10','10-33', '17', ['D', '2'], '1200', 'Low-Low'],
    'od razors edge slicer (during hooligan combination) (no input)': ['10','10-33', '17', ['D', '2'], '1200', 'Low-Low'],
    ...
    'reverse edge (charged) (during hooligan combination)': ['18', '18-39', '13 frames after landing', ['8', '-2'], '1200', 'Mid-Mid'],
    'od reverse edge (during hooligan combination)': ['18', '18-39', '13 frames after landing', ['8', '-2'], '1200', 'Mid-Mid'],
