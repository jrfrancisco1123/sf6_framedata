...
normals = {
        ...
        'clp': ['4', '4-5', '10', ['4', '-1'], '300', 'High'],
        'cmp': ['8', '8-10', '16', ['3', '-2'], '700', 'High'],
        'chp': ['9', '9-13', '23', ['D', '-6'], '900', 'High'],
        'chp (charged)': ['21', '21-26', '21', ['D', '-3'], '1000', 'High'],
        'clk': ['5', '5-7', '12', ['2', '-3'], '300', 'Low'],
        'cmk': ['9', '9-11', '18', ['3', '-2'], '600', 'Low'],
        ...
        'jhk (charged)': ['29', '29-34', '3 frames after landing', ['', ''], '1500', 'Mid']
    }
...
specials = {
    ...
    'light phalanx': ['25', '25-30', '15', ['D', '2'], '1500', 'High'],
    'medium phalanx': ['28', '28-33', '15', ['D', '2'], '1600', 'High'],
    'heavy phalanx': ['32', '32-37', '15', ['D', '2'], '1700', 'High'],
    'od phalanx': ['28', '28-33', '15', ['D', '4'], '1400', 'High'],
