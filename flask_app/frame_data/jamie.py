...
normals = {
        ...
        'mp': ['8', '8-11', '14', ['6', '2'], '600', 'High'],
        'hp': ['5', '5-14', '20', ['1', '-3'], '900', 'High'],
        'lk': ['5', '5-6', '11', ['3', '-1'], '300', 'High'],
        'mk': ['9', '9-11', '17', ['2', '-3'], '600', 'High'],
        'hk': ['15', '15-17', '21', ['3', '-5'], '800', 'High'],
        'clp': ['4', '4-5', '9', ['5', '-1'], '250', 'High'],
        'cmp': ['6', '6-8', '13', ['5', '-1'], '600', 'High'],
        'chp': ['8', '8-12', '23', ['0', '-8'], '900', 'High'],
...
uniques = {
    ...
    'bitter strikes (3)': ['8', '8-10', '21', ['-1', '-10'], '500', 'High'],
...
specials = {
    ...
    'light arrow kick': ['5', '5-50', '52', ['D', '-45'], '1000', 'High'],
    'medium arrow kick': ['8', '8-43', '51', ['D', '-43'], '1200', 'High'],
    'heavy arrow kick': ['10', '10-57', '51', ['D', '-43'], '1400', 'High'],
    ...
    'heavy bakkai': ['25', '25-92', '32', ['D', '-17'], '1800', 'High'],
