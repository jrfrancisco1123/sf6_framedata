...
normals = {
        'lp': ['5', '5-6', '11', ['4', '-3'], '300', 'High'],
        'mp': ['8', '8-10', '15', ['6', '0'], '600', 'High'],
        'hp': ['19', '19-21', '17', ['4', '1'], '1000', 'High'],
        'lk': ['4', '4-5', '10', ['3', '-1'], '300', 'High'],
        'mk': ['10', '10-12', '17', ['2', '-3'], '700', 'High'],
...
specials = {
    'light psycho crusher attack': ['14', '14-29', '24', ['D', '-20'], '1200', 'High'],
    'light psycho crusher attack (psycho mine)': ['16', '16-31', '24', ['D', '6'], '1700', 'High'],
    'medium psycho crusher attack': ['20', '20-35', '24', ['D', '-20'], '1400', 'High'],
    'medium psycho crusher attack (psycho mine)': ['20', '20-35', '24', ['D', '6'], '1900', 'High'],
    'heavy psycho crusher attack': ['24', '24-49', '24', ['D', '-23'], '1600', 'High'],
    'heavy psycho crusher attack (psycho mine)': ['24', '24-49', '24', ['D', '5'], '2100', 'High'],
    'od psycho crusher attack': ['16', '16-31', '20', ['D', '-3'], '1300', 'High'],
    'od psycho crusher attack (psycho mine)': ['16', '16-31', '20', ['D', '10'], '1600', 'High'],
    ...
    'devil reverse': ['16', '16-until landing', '10 frames after landing', ['D', '2~8'], '800', 'Mid'],
    'devil reverse (psycho mine)': ['16', '16-until landing', '10 frames after landing', ['D', '22~28'], '2000', 'Mid-High'],
    'od devil reverse': ['21', '21-until landing', '10 frames after landing', ['D', '4'], '1400', 'Mid-High'],
    'od devil reverse (psycho mine)': ['21', '21-until landing', '10 frames after landing', ['D', '24'], '2600', 'Mid-High']
}

super_arts = {
    'knee press nightmare': ['10', '10-51', '62', ['D', '-41'], '2000', 'High'],
    'pyscho punisher': ['26', '26-32', '52', ['D', '-34'], '3000', 'High'],
    'unlimited psycho crusher': ['10', '10-15', '65', ['D', '-46'], '4000', 'High'],
    'unlimited psycho crusher (under 25% vit)': ['10', '10-15', '65', ['D', '-46'], '4500', 'High']
}
