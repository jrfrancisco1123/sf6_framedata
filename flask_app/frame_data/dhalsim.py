...
uniques = {
    ...
    'agile kick': ['5', '5-7', '10', ['1', '-3'], '200', 'Low'],
...
specials = {
    ...
    'light yoga fire (charged)': ['43', '', '73 total frames', ['D', '-1'], '800', 'High-Projectile'],
    'medium yoga fire': ['15', '', '48 total frames', ['-2', '-6'], '600', 'High-Projectile'],
    'medium yoga fire (charged)': ['43', '', '73 total frames', ['D', '-1'], '800', 'High-Projectile'],
    'heavy yoga fire': ['15', '', '48 total frames', ['-2', '-6'], '600', 'High-Projectile'],
    'heavy yoga fire (charged)': ['43', '', '73 total frames', ['D', '-1'], '800', 'High-Projectile'],
    'od light yoga fire': ['12', '', '45 total frames', ['D', '-3'], '1000', 'High-Projectile'],
    'od medium yoga fire': ['12', '', '45 total frames', ['D', '-3'], '1000', 'High-Projectile'],
    'od heavy yoga fire': ['12', '', '45 total frames', ['D', '-3'], '1000', 'High-Projectile'],
    ...
    'heavy yoga blast': ['17', '17-26', '44 total frames', ['D', '-3'], '1200', 'High'],
...
super_arts = {
    'light yoga inferno': ['10', '10-93', '128 total frames', ['D', '-10'], '1920', 'High-Projectile'],
    'medium yoga inferno': ['10', '10-93', '128 total frames', ['D', '-10'], '2100', 'High-Projectile'],
