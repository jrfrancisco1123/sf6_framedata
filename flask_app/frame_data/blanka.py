...
normals = {
        ...
        'jhp (neutral jump)': ['7', '7-9', '3 frames after landing', ['', ''], '800', 'Mid']
}
...
specials = {
    ...
    'blanka-chan bomb (activated)': ['36', '', '', ['D', ''], '800', 'Projectile'],
    'od blanka-chan bomb (activated)': ['36', '', '', ['D', ''], '1200', 'Projectile'],
    'rolling cannon': ['3', '3-27', '9 frames of recovery upon landing', ['D', ''], '400', 'High']
}

super_arts = {
    'shout of earth': ['8', '8-16', '78 total frames', ['D', '-29'], '2000', 'Projectile'],
