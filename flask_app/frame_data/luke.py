...
normals = {
        ...
        'clk': ['5', '5-7', '11', ['0', '-3'], '200', 'Low'],
        'cmk': ['8', '8-10', '19', ['-2', '-6'], '500', 'Low'],
        'chk': ['10', '10-12', '24', ['D', '-9'], '900', 'Low'],
...
uniques = {
    ...
    'outlaw kick': ['12', '12-15', '24', ['4', '-3'], '1000', 'High'],
    ...
    'nosebreaker': ['9', '9-11', '25', ['2', '-8'], '600', 'High'],
...
specials = {
    ...
    'heavy sandblast': ['20', '20-29', '47 total frames', ['3', '-2'], '600', 'High-Projectile'],
    'od sandblast': ['16', '', '40 total frames', ['D', '-2'], '800', 'High-Projectile'],
    'fatal shot': ['8', '', '50 total frames', ['D', '-21'], '1000', 'High-Projectile'],
    ...
    'medium flash knuckle': ['19', '19-21', '27', ['3', '-8'], '900', 'High'],
    'medium flash knuckle (charged)': ['29', '29-32', '26', ['D', '-3'], '1000', 'High'],
    ...
    'od chaser': ['12', '12-21', '16', ['D', '-6'], '1300', 'High'],
    'impaler': ['13', '13', '22', ['D', '-8'], '1200', 'Mid'],
    'od impaler': ['13', '13', '19', ['D', '-3'], '1200', 'Mid'],
...
super_arts = {
    ...
    'eraser': ['5', '5-7', '51', ['D', '-29'], '2800', 'High'],
